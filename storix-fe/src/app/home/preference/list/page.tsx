// src/app/home/preference/list/page.tsx
'use client'
  ...
  return (
    <main className="min-h-dvh bg-white flex flex-col">
      ...
      <div className="h-13 px-4 flex items-center justify-center relative">
        ...
        <div className="body-1-medium text-black">취향 저격 작품 탐색</div>

        <button
          type="button"
          onClick={() => router.push('/home/preference/finish')}
          className="absolute right-4 body-1-medium text-[var(--color-magenta-300)] cursor-pointer"
        >
          완료
        </button>
      </div>
      ...
      <div className="relative">
        <div className="grid grid-cols-2 body-1-medium border-b border-gray-200">
          <button
            type="button"
            onClick={() => setTab('like')}
            className={[
              'py-3 text-center cursor-pointer',
              tab === 'like' ? 'text-gray-900' : 'text-gray-400',
            ].join(' ')}
          >
            좋아요
          </button>
          <button
            ...
            className={[
              'py-3 text-center cursor-pointer',
              tab === 'dislike' ? 'text-gray-900' : 'text-gray-400',
            ].join(' ')}
          >
            별로에요
          </button>
